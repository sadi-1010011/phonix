...
export default function LoginPage() {
  ...
  {/* Primary Action */}
  <div className="px-6 py-4">
    <button className="w-full bg-primary hover:bg-blue-700 active:bg-blue-800 text-white font-bold h-12 rounded-xl shadow-lg shadow-primary/30 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2">
      <span>Log In</span>
